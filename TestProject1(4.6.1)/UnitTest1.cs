...
namespace Test
{
    public class Test
    {
        ...
        public void TestApplyDecisionRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v3/accounts/123/users/gary/orders/1/decisions",
                         applyDecisionRequest.Request.RequestUri.ToString());

            Assert.AreEqual(Convert.ToBase64String(Encoding.Default.GetBytes("key")),
        ...
        public void TestEventRequest()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_booking_with_all_fields\"," +
            ...
            Assert.AreEqual("https://api.sift.com/v205/events", eventRequest.Request.RequestUri.ToString());
            ...
            Assert.AreEqual("https://api.sift.com/v205/events?abuse_types=legacy,payment_abuse&return_score=true&return_route_info=true",
        ...
        public void TestCustomEventRequest()
        {
            ...
            Assert.AreEqual("{\"$type\":\"make_call\",\"$user_id\":\"gary\",\"foo\":" +
        ...
        public void TestEventWithBrowser()
        {
            ...
            // Augment with custom fields
            createOrder.AddField("foo", "bar");
            Assert.AreEqual("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_browser_field\",\"$session_id\":\"sessionId\"," +
            ...
            Assert.AreEqual("https://api.sift.com/v205/events?abuse_types=legacy,payment_abuse&return_score=true",
                         Uri.UnescapeDataString(eventRequest.Request.RequestUri.ToString()));
        }
        ...
        public void TestTransactionEvent()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$transaction\",\"$user_id\":\"test_dotnet_transaction_event\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestCreateOrderEventWithSepaPaymentMethodFields()
        {
            ...
            // Augment with custom fields
            createOrder.AddField("foo", "bar");
            Assert.AreEqual("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_sepa_payment_method_fields\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestCreateOrderEventWithMerchantProfileField()
        {
            ...
            // Augment with custom fields
            createOrder.AddField("foo", "bar");
            Assert.AreEqual("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_merchant_profile_field\",\"$session_id\":\"sessionId\"," +
                                 "\"$order_id\":\"12345\",\"$payment_methods\":[{\"$payment_type\":\"$sepa_instant_credit\",\"$shortened_iban_first6\":\"FR7630\"," +
        ...
        public void TestUpdateOrderEventWithCryptoFields()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$update_order\",\"$user_id\":\"test_dotnet_merchant_profile_field\",\"$session_id\":\"sessionId\"," +
            "\"$order_id\":\"12345\"," +
            "\"$payment_methods\":[" +
            "{" +
            "\"$wallet_address\":\"ZplYVmchAoywfMvC8jCiKlBLfKSBiFtHU6\"," +
        ...
        public void TestCreateOrderEventWithWirePaymentMethod()
        {
            ...
            // Augment with custom fields
            createOrder.AddField("foo", "bar");
            Assert.AreEqual("{\"$type\":\"$create_order\",\"$user_id\":\"test_dotnet_wire_payment_methods\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestVerificationCheckRequest()
        {
            ...
            Assert.AreEqual(Convert.ToBase64String(Encoding.Default.GetBytes(apiKey)),
                verificationCheckRequest.Request.Headers.Authorization.Parameter);

            Assert.AreEqual("https://api.sift.com/v1.1/verification/check",
        ...
        public void TestVerificationSendRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v1.1/verification/send",
        ...
        public void TestVerificationReSendRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v1.1/verification/resend",
        ...
        public void TestGetMerchantsRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v3/accounts/" + accountId + "/psp_management/merchants",
        ...
        public void TestUpdateMerchantRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v3/accounts/" + accountId + "/psp_management/merchants/test2",
                         updateMerchantRequest.Request.RequestUri.ToString());


            Assert.AreEqual("{\"id\":\"test-vineeth-5\"," +
                "\"name\":\"Wonderful Payments Inc\"," +
                "\"description\":\"Wonderful Payments payment provider\"," +
                "\"address\":{\"name\":\"Alany\"," +
                ...
                "\"risk_profile\":{\"level\":\"low\",\"score\":10}}",
                               JsonConvert.SerializeObject(updateMerchantRequest));
        ...
        public void TestGetMerchantDetailsRequest()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v3/accounts/" + accountId + "/psp_management/merchants/test-merchat-id",
        ...
        public void TestChargebackEvent()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$chargeback\",\"$user_id\":\"test_dotnet_chargeback_event\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestCreateAccountEvent()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$create_account\",\"$user_id\":\"test_dotnet_create_account_event\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestUpdateAccountEvent()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$update_account\",\"$user_id\":\"test_dotnet_update_account_event\",\"$session_id\":\"sessionId\"," +
                                 "\"$user_email\":\"bill@gmail.com\",\"$name\":\"Bill Jones\",\"$referrer_user_id\":\"janejane101\",\"$social_sign_on_type\":" +
                                 "\"$twitter\",\"$merchant_profile\":{\"$merchant_id\":\"123\",\"$merchant_category_code\":\"9876\",\"$merchant_name\":\"ABC Merchant\"," +
        ...
        public void TestLoginEvent()
        {
            ...
            Assert.AreEqual("{\"$type\":\"$login\",\"$user_id\":\"test_dotnet_login_event\",\"$session_id\":\"sessionId\"," +
        ...
        public void TestScorePercentile()
        {
            ...
            Assert.AreEqual("https://api.sift.com/v205/events?abuse_types=legacy,payment_abuse&fields=SCORE_PERCENTILES&return_score=true",
                          Uri.UnescapeDataString(eventRequest.Request.RequestUri.ToString()));
        }
    }
}